...
has api_factory => ( is => 'ro',
                     isa => 'WWW::DialMyCalls::ApiFactory',
                     builder => '_build_af', 
                     lazy => 1,
...
has _cfg => ( is => 'ro',
              isa => 'Str',
              default => 'WWW::DialMyCalls::Configuration',
              );

has version_info => ( is => 'ro', 
                      isa => 'HashRef', 
                      default => sub { {
                          app_name => 'DialMyCalls API',
                          app_version => '2.0.1',
                          generated_date => '2016-07-28T11:47:35.312-04:00',
...
sub _build_af {
	...
	return WWW::DialMyCalls::ApiFactory->new(%args);
}
...
=head2 DialMyCalls API version: 2.0.1
...
=item Build date: 2016-07-28T11:47:35.312-04:00
...
The tokens will be placed in the C<WWW::DialMyCalls::Configuration> namespace
as follows, but you don't need to know about this. 

=over 4

=item C<$WWW::DialMyCalls::Configuration::username>

String. The username for basic auth.

=item C<$WWW::DialMyCalls::Configuration::password>

String. The password for basic auth.

=item C<$WWW::DialMyCalls::Configuration::api_key>

Hashref. Keyed on the name of each key (there can be multiple tokens).

	$WWW::DialMyCalls::Configuration::api_key = {
		secretKey => 'aaaabbbbccccdddd',
		anotherKey => '1111222233334444',
		};

=item C<$WWW::DialMyCalls::Configuration::api_key_prefix>

Hashref. Keyed on the name of each key (there can be multiple tokens). Note not
all api keys require a prefix.

	$WWW::DialMyCalls::Configuration::api_key_prefix = {
		secretKey => 'string',
		anotherKey => 'same or some other string',
		};

=item C<$WWW::DialMyCalls::Configuration::access_token>
...
Returns an API factory object. You probably won't need to call this directly. 
        ...
        $self->api_factory('Pet'); # returns a WWW::DialMyCalls::PetApi instance
